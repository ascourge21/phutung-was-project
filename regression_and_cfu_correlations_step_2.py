...
def plot_regression(fdf):
    ...
    slope, intercept, r_value, p_value, std_err = stats.linregress(fdf['TLF'],fdf['cfu'])
    ...
    slope, intercept, r_value, p_value, std_err = stats.linregress(fdf['HLF'],fdf['cfu'])
    print('slope, intercept, r_value, p_value, std_err ',slope, intercept, r_value, p_value, std_err )
...
final_dataframe = perform_regression(save_path_normed,save_path_interped,save_path_regressed)
